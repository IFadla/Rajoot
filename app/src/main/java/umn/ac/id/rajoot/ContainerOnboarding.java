...
public class ContainerOnboarding extends AppCompatActivity {
    private TextView tvNext;
    private ViewPager viewPager;
    private LinearLayout layoutDots;
    private OnboardingPref onboardingPref;
    private int[] layouts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_container_onboarding);

        // Hide actionbar this splashscreen
        getSupportActionBar().hide();

        onboardingPref = new OnboardingPref(this);
        if (!onboardingPref.isFirstTimeLaunch()) {
            launchStartScreen();
            finish();
        }
    ...
    private void launchStartScreen() {
        onboardingPref.setIsFirstTimeLaunch(false);
        startActivity(new Intent(ContainerOnboarding.this, StartActivity.class));
        finish();
    }
}