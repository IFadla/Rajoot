...
//Manage view every product on Sale item
public class CraftItemAdapter extends RecyclerView.Adapter<CraftItemAdapter.ItemViewHolder> {
    private ArrayList<ItemModel> dataList;
    public CraftItemAdapter(ArrayList<ItemModel> dataList) {
        this.dataList = dataList;
    }

    @NonNull
    @Override
    public CraftItemAdapter.ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CraftItemAdapter.ItemViewHolder holder, int position) {
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), UpdateCraftActivity.class);
